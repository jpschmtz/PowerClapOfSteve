		...
		return (
          ...
          <div id="bannerDiv">
					...
					<div className="datesWrapper">
						...
						<p>It's extremely important to meet individuals with similar interests and hobbies. This will give you a chance to grow your network, which is crucial to succeeding in this industry. </p>
						<code>
						<Meetups
							apiKey={apiKey}
							meetupsIds={meetupsIds}
